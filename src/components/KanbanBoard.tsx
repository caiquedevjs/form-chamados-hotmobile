                ...
                <Grid item xs={12} md={8} display="flex" flexDirection="column">
                  <Box sx={{ flexGrow: 1, bgcolor: isDark?'rgba(0,0,0,0.2)':'#f9f9f9', borderRadius: 2, p: 2, mb: 2, border: '1px solid', borderColor: 'divider', maxHeight: '400px', overflowY: 'auto'}}>
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', mb: 2 }}>
                        <Box display="flex" gap={1} mb={0.5}><Avatar sx={{ width: 24, height: 24, bgcolor: '#9e9e9e' }}><PersonIcon fontSize="small" /></Avatar><Typography variant="caption" fontWeight="bold">Cliente (Abertura)</Typography></Box>
      ...
      <Dialog open={modalSlaOpen} onClose={() => setModalSlaOpen(false)}>
        ...
        <DialogContent>
            ...
            <Typography variant="body2" paragraph>
                Existem <strong>{metricasSla.estourados}</strong> chamados abertos há mais de 24 horas.
            </Typography>
            <Box bgcolor="#ffebee" p={2} borderRadius={1} border="1px solid #ffcdd2">
                <Typography variant="caption" fontWeight="bold" color="error">
                    Total Pendente: {metricasSla.totalAbertos} | Estourados: {metricasSla.estourados}
                </Typography>
            </Box>
            <Typography variant="caption" color="text.secondary" sx={{ mt: 2, display: 'block' }}>
                O tempo de espera e resolução são registrados no Dashboard para análise.
            </Typography>
        </DialogContent>
        <DialogActions>
